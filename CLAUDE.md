...
* The `.env` file is created by copying the `.env.example` file into the release folder.

A release build can be generated by running the build script with the version parameter:
